...
/** @type {string} */
const CACHE_VERSION = '1766315549|2777198740';
/** @type {string} */
const CACHE_PREFIX = 'kjuchimiuk-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'kjuchimiuk.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["kjuchimiuk.html","kjuchimiuk.js","kjuchimiuk.offline.html","kjuchimiuk.audio.worklet.js","kjuchimiuk.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["kjuchimiuk.wasm","kjuchimiuk.pck"];
